...
public class ScoresAdapter extends CursorAdapter
{
    ...
    {
        String ts = cursor.getString(COL_HOME);
...
//        Log.v(MyFetchService.LOG_TAG, (String) mHolder.score.getText());

        String matchDescription = mHolder.home_name.getText() +  " Vs. " + mHolder.away_name.getText();
        ...
        //Set content description for Usability
        v.setContentDescription(matchDescription);
        ViewGroup container = (ViewGroup) view.findViewById(R.id.details_fragment_container);
        if(mHolder.match_id == detail_match_id)
        {
            Log.v(MyFetchService.LOG_TAG,"will insert extraView");
